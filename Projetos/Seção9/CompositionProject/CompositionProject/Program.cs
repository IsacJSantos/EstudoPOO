...
namespace CompositionProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Emter worker data");
            Console.Write("Name: ");
            ...
            Department dept = new Department(deptNme);
            ...
            Console.WriteLine("Incame for " + monthAndYear + ": " + worker.Income(year,month).ToString("F2",CultureInfo.InvariantCulture));
